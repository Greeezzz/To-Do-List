...
<body class="bg-gray-100">
    ...
    <div class="min-h-screen flex flex-col justify-center items-center">
        ...
        <!-- Buttons -->
        <div class="mt-8">
            <a href="<?php echo e(route('login')); ?>" class="bg-blue-500 text-white py-2 px-4 rounded mr-4 hover:bg-blue-600 transform hover:scale-105 transition-transform duration-300">Login</a>
            <a href="<?php echo e(route('register')); ?>" class="bg-green-500 text-white py-2 px-4 rounded hover:bg-green-600 transform hover:scale-105 transition-transform duration-300">Register</a>
        </div>
    </div>

</body>
</html><?php /**PATH C:\laragon\www\tasklistchelodewi2\resources\views/welcome.blade.php ENDPATH**/ ?>